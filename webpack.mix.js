 ...
 */
    ...
    mix.options({processCssUrls: false}).sass('resources/scss/icons.scss', folder.dist_assets + "css").minify(folder.dist_assets + "css/f.css");
    ...
    var app_pages_assets = {
        js: [
            ...
            folder.src + "js/pages/cropperjs.init.js",
