...
var chart = new ApexCharts(document.querySelector("#area-sparkline-chart-1"), options);
chart.render(); // Area sparkline 2
...
var chart = new ApexCharts(document.querySelector("#area-sparkline-chart-2"), options);
chart.render(); // Area sparkline 3
...
var chart = new ApexCharts(document.querySelector("#area-sparkline-chart-3"), options);
chart.render(); // wallet-balance-chart
...
var chart = new ApexCharts(document.querySelector("#wallet-balance-chart"), walletOptions);
chart.render(); // Overview chart
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\aix\resources\js\pages\crypto-dashboard.init.js */"./resources/js/pages/crypto-dashboard.init.js");
